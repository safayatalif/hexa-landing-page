...
import aboutBanner from '../../../src/assets/about-image/Image.png';
...
export const About: React.FC = () => {
    ...
    return (
        <>
            ...
            <div>
                <Typography variant="title-md-semibold" alignment="center">
                    The Dream Team
                </Typography>
            </div>
            ...
            <div>
                ...
                <Typography variant="text-lg-regular" alignment="center">
