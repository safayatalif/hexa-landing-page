        ...
        <div className={styles.movingContainer}>
            <div className={styles.heading}>
                <Typography variant="title-2xl-semibold">
                    ...
                    <br />{' '}
                    <span className={styles.heading2}>At your own pace.</span>
                </Typography>
            </div>
            ...
            <Typography variant="text-xl-medium" alignment="center">
                The goal, always, is to try and ensure that you have access to
                as many resources as possible, without having to open another
                tab, or another website. Which swiftly takes us to the Practice
                section.
            </Typography>
